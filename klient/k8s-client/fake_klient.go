...
type FakeKlient struct {
	...
	FakeApplyResource                  func(ctx context.Context, object *spec.ResourceObject) (*entity.KubernetesResource, error)
	FakeApplyResources                 func(ctx context.Context, objects []spec.ResourceObject) ([]entity.KubernetesResource, error)
	...
	FakeGetPods                        func(ctx context.Context, namespace string, labels map[string]string) ([]corev1.Pod, error)
	...
	FakeGetVolumeSnapshot              func(ctx context.Context, namespace, name string) (*k8s.VolumeSnapshot, error)
	FakeGetVolumeSnapshots             func(ctx context.Context, namespace string, labels map[string]string) []k8s.VolumeSnapshot
...
func (f FakeKlient) GetResource(object *unstructured.Unstructured) *entity.KubernetesResource {
	//TODO implement me
	panic("implement me")
}
...
func (f FakeKlient) ApplyResource(ctx context.Context, object *spec.ResourceObject) (*entity.KubernetesResource, error) {
	return f.FakeApplyResource(ctx, object)
}

func (f FakeKlient) ApplyResources(ctx context.Context, objects []spec.ResourceObject) ([]entity.KubernetesResource, error) {
...
func (f FakeKlient) GetPods(ctx context.Context, namespace string, labels map[string]string) ([]corev1.Pod, error) {
...
func (f FakeKlient) GetVolumeSnapshot(ctx context.Context, namespace, name string) (*k8s.VolumeSnapshot, error) {
	return f.FakeGetVolumeSnapshot(ctx, namespace, name)
}

func (f FakeKlient) GetVolumeSnapshots(ctx context.Context, namespace string, labels map[string]string) []k8s.VolumeSnapshot {
